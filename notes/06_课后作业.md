...
> <p>主讲人：曹茂松</p> <p>作业记录人：杨智凯</p> <p>作业作答时间：2024.2.14</p>
...
```shell
python run.py configs/eval_internlm2_chat_7b_turbomind.py
```

一段时间过后，我们可以获得使用 OpenCompass 工具对 LMDeploy 生成的 InternLM2-Chat-7B TurboMind 模型在 C-Eval 数据集上进行评测的评测结果。测评结果如下图所示：

<img src="../pics/06/H3.png" alt="图 3 InternLM2-Chat-7B LMDeploy 部署模型在 C-Eval 数据集上的评测结果" style="width: 60%">
