...
- 镜像：AUTOMATIC1111/stable-diffusion-webui（by趋动云小助手，10.78GB，搜索选择）
- 数据：stable-diffusion-models（by趋动云小助手，搜索选择）
- 模型：stable-diffusion-webui（by趋动云小助手，87.41GB，搜索选择）
...
通过这次机会，我们体验了如何自己构建属于自己的 Stable-Diffusion 模型。我从这一过程中也发现，Stable-Diffusion所需的硬件资源较小，大大地推动了普通消费者体验 Stable-Diffsion的机会。对于相关 Prompt 的编写，也是值得深究的内容，也可以参考下面几篇文章：
